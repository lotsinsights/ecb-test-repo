...
// import "./DivisionScorecardFromUsers.scss";
...
//     const perpectiveObjectives = objectives.filter(
//       (o) => o.perspective === filter
//     );
...
// const DivisionScorecardObjective = observer((props: IProps) => {
//   const { divisionId } = props;
//   const { store } = useAppContext();
//   const [tab, setTab] = useState(ALL_TAB.id);

//   const groupedByDivision = () => {
//     const usersId = store.user.all.filter((d) => d.asJson.division === divisionId && !d.asJson.devUser).map((u) => u.asJson.uid);
//     return usersId;
//   };

//   const getObjectives = () => {
//     let objectives: Objective[] = [];
//     groupedByDivision().map((uId) => {
...
// export default DivisionScorecardObjective;
