...
// export default class DepartmentScorecardReviewQuarter2Api {
...
//       this.store.departmentScorecardReview.quarter2.load([item]);
//     });
...
//           this.store.departmentScorecardReview.quarter2.load(items);
//           resolve(unsubscribe);
//         },
//         // onError
//         (error) => {
...
//       // remove from store
//       this.store.departmentScorecardReview.quarter2.remove(item.uid); // Remove from memory
//     } catch (error) {
//       // console.log(error);
//     }
//   }
