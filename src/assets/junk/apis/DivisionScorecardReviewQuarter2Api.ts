...
// export default class DivisionScorecardReviewQuarter2Api {
...
//       this.store.divisionScorecardReview.quarter2.load([item]);
//     });
...
//           this.store.divisionScorecardReview.quarter2.load(items);
//           resolve(unsubscribe);
//         },
//         // onError
//         (error) => {
...
//       // remove from store
//       this.store.divisionScorecardReview.quarter2.remove(item.uid); // Remove from memory
//     } catch (error) {
//       // console.log(error);
//     }
//   }
