...
// export default class DepartmentScorecardReviewQuarter1Api {
...
//       this.store.departmentScorecardReview.quarter1.load([item]);
//     });
...
//           this.store.departmentScorecardReview.quarter1.load(items);
//           resolve(unsubscribe);
//         },
//         // onError
//         (error) => {
...
//       // remove from store
//       this.store.departmentScorecardReview.quarter1.remove(item.uid); // Remove from memory
//     } catch (error) {
//       // console.log(error);
//     }
//   }
