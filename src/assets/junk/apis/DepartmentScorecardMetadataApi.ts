...
// export default class DepartmentScorecardMetadataApi {
...
//       "scorecardMetadata" // departmentScorecardMetadata
//     );
//   }
...
//       this.store.departmentScorecardMetadata.load([item]);
//     });
...
//           this.store.departmentScorecardMetadata.load(items);
//           resolve(unsubscribe);
//         },
//         // onError
//         (error) => {
...
//       // remove from store
//       this.store.departmentScorecardMetadata.remove(item.uid); // Remove from memory
//     } catch (error) {
//       // console.log(error);
//     }
//   }
