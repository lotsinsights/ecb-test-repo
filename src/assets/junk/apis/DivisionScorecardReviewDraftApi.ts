...
// export default class DivisionScorecardReviewDraftApi {
...
//       this.store.divisionScorecardReview.draft.load([item]);
//     });
...
//           this.store.divisionScorecardReview.draft.load(items);
//           resolve(unsubscribe);
//         },
//         // onError
//         (error) => {
...
//       // remove from store
//       this.store.divisionScorecardReview.draft.remove(item.uid); // Remove from memory
//     } catch (error) {
//       // console.log(error);
//     }
//   }
