...
// import { defaultReview, IScorecardReview } from "../../../shared/models/ScorecardReview";
...
// import AppApi, { apiPathScorecardLevel } from "../../../shared/apis/AppApi";

// export default class DivisionScorecardReviewQuarter4Api {
...
//       this.store.divisionScorecardReview.quarter4.load([item]);
//     });
...
//           this.store.divisionScorecardReview.quarter4.load(items);
//           resolve(unsubscribe);
//         },
//         // onError
//         (error) => {
...
//       // remove from store
//       this.store.divisionScorecardReview.quarter4.remove(item.uid); // Remove from memory
//     } catch (error) {
//       // console.log(error);
//     }
//   }
...
//     measures: IMeasure[] | IMeasureDivision[] | IMeasureCompany[],
//     measureAudits:
//       | IMeasureAudit[]
