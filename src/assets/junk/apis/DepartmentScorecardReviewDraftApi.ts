...
// export default class DepartmentScorecardReviewDraftApi {
...
//       this.store.departmentScorecardReview.draft.load([item]);
//     });
...
//           this.store.departmentScorecardReview.draft.load(items);
//           resolve(unsubscribe);
//         },
//         // onError
//         (error) => {
...
//       // remove from store
//       this.store.departmentScorecardReview.draft.remove(item.uid); // Remove from memory
//     } catch (error) {
//       // console.log(error);
//     }
//   }
