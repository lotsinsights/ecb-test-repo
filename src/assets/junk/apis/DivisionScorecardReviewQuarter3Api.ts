...
// export default class DivisionScorecardReviewQuarter3Api {
...
//       this.store.divisionScorecardReview.quarter3.load([item]);
//     });
...
//           this.store.divisionScorecardReview.quarter3.load(items);
//           resolve(unsubscribe);
//         },
//         // onError
//         (error) => {
...
//       // remove from store
//       this.store.divisionScorecardReview.quarter3.remove(item.uid); // Remove from memory
//     } catch (error) {
//       // console.log(error);
//     }
//   }
