...
// export default class DivisionScorecardReviewQuarter1Api {
...
//       this.store.divisionScorecardReview.quarter1.load([item]);
//     });
...
//           this.store.divisionScorecardReview.quarter1.load(items);
//           resolve(unsubscribe);
//         },
//         // onError
//         (error) => {
...
//       // remove from store
//       this.store.divisionScorecardReview.quarter1.remove(item.uid); // Remove from memory
//     } catch (error) {
//       // console.log(error);
//     }
//   }
