...
// import { IMeasureAuditDepartment } from "../../assets/junk/models/MeasureAuditDepartment";
...
// export default class DepartmentScorecardReviewQuarter3Api {
...
//       this.store.departmentScorecardReview.quarter3.load([item]);
//     });
...
//           this.store.departmentScorecardReview.quarter3.load(items);
//           resolve(unsubscribe);
//         },
//         // onError
//         (error) => {
...
//       // remove from store
//       this.store.departmentScorecardReview.quarter3.remove(item.uid); // Remove from memory
//     } catch (error) {
//       // console.log(error);
//     }
//   }
