...
// export default class DivisionScorecardMetadataApi {
...
//       "scorecardMetadata" // divisionScorecardMetadata
//     );
//   }
...
//       this.store.divisionScorecardMetadata.load([item]);
//     });
...
//           this.store.divisionScorecardMetadata.load(items);
//           resolve(unsubscribe);
//         },
//         // onError
//         (error) => {
...
//       // remove from store
//       this.store.divisionScorecardMetadata.remove(item.uid); // Remove from memory
//     } catch (error) {
//       // console.log(error);
//     }
//   }
