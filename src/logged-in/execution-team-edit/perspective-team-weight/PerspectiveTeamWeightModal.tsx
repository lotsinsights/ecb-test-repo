...
import PerspectiveWeightForm from "./PerspectiveTeamWeightForm";

const PerspectiveTeamWeightModal = observer(() => {
  ...
  const onCancel = () => {
    ...
    hideModalFromId(MODAL_NAMES.TEAM.TEAM_PERSPECTIVE_MODAL);
  };
...
export default PerspectiveTeamWeightModal;
