...
import ReviewPeople from "./DivisionReviewPeople";
import ReviewStep from "./DivisionReviewStep";
...
const DivisionPerformanceReviews = observer(() => {
  ...
  useTitle("Division Performance Reviews"); // set page title
