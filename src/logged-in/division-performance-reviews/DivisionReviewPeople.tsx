...
interface IDivisionReviewPeopleProps {
  scorecards: IScorecardMetadata[];
}
const DivisionReviewPeople = observer((props: IDivisionReviewPeopleProps) => {
    ...
    <ErrorBoundary>
      <div className="review-staff">
        ...
        >
          ...
          leftControls={
            <h6 className="title">Division Reviews</h6>
          }
...
export default DivisionReviewPeople;
