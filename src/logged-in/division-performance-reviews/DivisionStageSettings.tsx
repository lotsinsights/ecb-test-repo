...
const DivisionStageSettings = (props: IReviewInfoProps) => {
  const { api, store } = useAppContext();
  const { openStage, batch, setBatch, unsavedChanges, discardChanges } = props;

  const [submitType, setSubmitType] = useState<
    "SAVE_CHANGES" | "START_SESSION" | "END_SESSION"
  >("SAVE_CHANGES");
  ...
  const onMail = () => {
    showModalFromId(MODAL_NAMES.PERFORMANCE_REVIEW.MAIL_ALL_EMPLOYEES_MODAL);
  };
...
export default DivisionStageSettings;
