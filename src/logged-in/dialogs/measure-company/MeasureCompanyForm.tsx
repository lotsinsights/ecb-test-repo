        ...
        <ErrorBoundary>
          ...
          <div className="uk-width-1-3">
            <label className="uk-form-label" htmlFor="kpi-q4-target">
              End of the Year ({measure.dataSymbol})
              <FormFieldInfo>
                Targets are the desired level of performance for each measure
                for End of the Year of the financial year.
              </FormFieldInfo>
            </label>
            <div className="uk-form-controls">
              <NumberInput
        ...
        <ErrorBoundary>
          ...
          <div className="uk-width-1-3">
            <label className="uk-form-label" htmlFor="kpi-rate2">
              ...
              <FormFieldInfo>
                Targets are the desired level of performance for each measure
                for midterm of the financial year.
              </FormFieldInfo>
            </label>
            <div className="uk-form-controls">
              <input
      ...
      <div className="uk-width-1-1">
        ...
        <div className="uk-form-controls">
          <NumberInput
            ...
            onChange={(value) =>
              setMeasure({ ...measure, weight: Number(value) })
            }
          />
        </div>
      </div>
