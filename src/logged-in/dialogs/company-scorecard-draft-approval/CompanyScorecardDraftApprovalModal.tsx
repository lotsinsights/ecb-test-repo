...
const CompanyScorecardDraftApprovalModal = observer((props: IProps) => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    $agreement.agreementDraft.comments = comment;
  ...
  const onCancel = () => {
    hideModalFromId(MODAL_NAMES.EXECUTION.COMPANY_DRAFT_APPROVAL_MODAL);
  };
        ...
        >
          <div className="uk-width-1-1">
            <label className="uk-form-label" htmlFor="kpi-appraisal">
              Feedback (optional)
              <div className="field-info uk-margin-small-left"></div>
            </label>
...
export default CompanyScorecardDraftApprovalModal;
