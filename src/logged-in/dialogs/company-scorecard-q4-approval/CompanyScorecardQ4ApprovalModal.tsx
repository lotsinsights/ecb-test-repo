...
const CompanyScorecardQ4ApprovalModal = observer((props: IProps) => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    $agreement.quarter4Review.comments = comment;
  ...
  const onCancel = () => {
    hideModalFromId(MODAL_NAMES.EXECUTION.COMPANY_Q4_APPROVAL_MODAL);
  };
  ...
  return (
    <div className="scorecard-approval-modal uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
      <button
        ...
        data-uk-close
      ></button>
      <h3 className="uk-modal-title">Quarter 4 Review Approval</h3>
      <div className="dialog-content uk-position-relative">
        <div
          className="uk-alert-primary uk-padding-small uk-margin"
          data-uk-alert>
          <p>The Quarter 4 will be locked after approval.</p>
        </div>
        <form
...
export default CompanyScorecardQ4ApprovalModal;
