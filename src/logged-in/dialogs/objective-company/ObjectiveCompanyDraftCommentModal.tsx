...
const ObjectiveCompanyDraftCommentModal = observer(() => {
  ...
  const onCancel = () => {
    ...
    hideModalFromId(MODAL_NAMES.EXECUTION.OBJECTIVE_COMPANY_DRAFT_COMMENT_MODAL);
  };
...
export default ObjectiveCompanyDraftCommentModal;
