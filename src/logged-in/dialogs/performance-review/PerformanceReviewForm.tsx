...
interface IProps {
  ...
  setPerformanceReview: React.Dispatch<
    React.SetStateAction<IScorecardMetadata>
  >;
}
      ...
      <div className="uk-margin-right">
        <label>
          <input
            ...
            type="checkbox"
            name="midtermRated"
            checked={performanceReview.midtermRated}
            onChange={(e) => {
              setPerformanceReview({
                ...performanceReview,
                midtermRated: e.target.checked,
              });
            }}
          />
          <span className="uk-margin-small-left">Midterm Rated</span>
        </label>
      </div>
      <div className="uk-margin-right">
        <label>
          <input
            className="uk-checkbox"
            type="checkbox"
            name="assessmentRated"
            checked={performanceReview.assessmentRated}
            onChange={(e) => {
              setPerformanceReview({
                ...performanceReview,
                assessmentRated: e.target.checked,
              });
            }}
          />
          <span className="uk-margin-small-left">Assessment Rated</span>
        </label>
      </div>
    </ErrorBoundary>
  );
