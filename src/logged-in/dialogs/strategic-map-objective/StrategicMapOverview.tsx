...
import { dataTypeSymbol, totalQ4IndividualObjectiveRating } from "../../shared/functions/Scorecard";
      ...
      <div className="grid">
                  ...
                  {measure.dataType !== "Currency" && (
                    <Fragment>
                      ...
                      <td className="kpi-actual">
                        <StatusDirection rating={measure.finalRating2 || 0} />
                        {dataTypeSymbol(measure.dataType).prefix}
        ...
        <div className="score uk-card uk-card-default uk-card-body uk-card-small">
          ...
          <div className="rating-container uk-margin">
            <Rating rate={rating} simple={false} />
          </div>
        </div>
      </div>
    </div>
