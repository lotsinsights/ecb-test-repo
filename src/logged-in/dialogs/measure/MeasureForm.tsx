...
const MeasureForm = observer((props: IProps) => {
  ...
  const [measureSymbol, setMeasureSymbol] = useState<string>(() => measure.dataSymbol);
    ...
    switch (dataType) {
      ...
      case "Currency":
        setMeasure({
          ...measure,
          dataType: dataType,
          dataSymbol: measureSymbol || "NAD",
          symbolPos: "prefix",
        });
        setMeasureSymbol("NAD");
        break;
      case "Time":
        setMeasure({
          ...measure,
          dataType: dataType,
          dataSymbol: measureSymbol || "Years",
          symbolPos: "prefix",
        });
        break;
      case "Custom":
      ...
      <div className="uk-width-1-1">
        ...
        <div className="uk-form-controls">
          <NumberInput
            ...
            onChange={(value) =>
              setMeasure({ ...measure, weight: NumberInputValue(value) })
            }
          />
          {/* <input
            id="kpi sub-weights"
