...
const MeasureCompanyUpdateQ4ActualForm = observer((props: IProps) => {
      ...
      {dataType !== "Date" && (
        <Fragment>
          <div className="uk-width-1-2">
            <label className="uk-form-label" htmlFor="kpi-q4">
              Assessment Actual ({dataTypeSymbol(dataType).symbol})
            </label>
            <div className="uk-form-controls">
              <NumberFormat
                id="kpi-q4"
                className="uk-input uk-form-small"
                placeholder="KPI Assessment"
                thousandsGroupStyle="thousand"
                displayType="input"
                decimalSeparator="."
                type="text"
                value={measure.quarter4Actual}
                onValueChange={(val) =>
                  setMeasure({
                    ...measure,
          ...
          <div className="uk-width-1-2">
            ...
            <div className="uk-form-controls">
              <input
                ...
                id="kpi-max"
                type="date"
                value={dateFormat(measure.annualActual || 0)}
                onChange={(e) =>
                  setMeasure({
                    ...measure,
...
export default MeasureCompanyUpdateQ4ActualForm;
...
<div className="uk-width-1-2">
          ...
          </div> <div className="uk-width-1-2">
            <label className="uk-form-label" htmlFor="kpi-q2">
              Midterm Actual({dataTypeSymbol(dataType).symbol})
            </label>
            <div className="uk-form-controls">
