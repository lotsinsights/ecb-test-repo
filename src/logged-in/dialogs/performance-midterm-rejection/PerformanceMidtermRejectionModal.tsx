...
import { MAIL_EMAIL, MAIL_MIDTERM_REJECTED_ME } from "../../../shared/functions/mailMessages";
import { hideModalFromId } from "../../../shared/functions/ModalShow";
import { IScorecardMetadata, defaultScorecardMetadata } from "../../../shared/models/ScorecardMetadata";
import MODAL_NAMES from "../ModalName";

const PerformanceMidtermRejectionModal = observer(() => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const { MY_SUBJECT, MY_BODY } = MAIL_MIDTERM_REJECTED_ME(user.displayName, me.displayName);
  ...
  const onCancel = () => {
    setComments("");
    hideModalFromId(MODAL_NAMES.EXECUTION.PERFORMANCE_MIDTERM_REJECTION_MODAL);
  };
  ...
  return (
    <div className="measure-modal uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
      <button
        ...
        data-uk-close
      ></button>
      <h3 className="uk-modal-title">Revert Midterm</h3>
...
export default PerformanceMidtermRejectionModal;
