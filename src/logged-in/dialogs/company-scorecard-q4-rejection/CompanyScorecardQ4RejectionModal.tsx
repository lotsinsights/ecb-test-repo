...
const CompanyScorecardQ4RejectionModal = observer((props: IProps) => {
  ...
  const onCancel = () => {
    hideModalFromId(MODAL_NAMES.EXECUTION.COMPANY_Q4_REJECTION_MODAL);
    setComments("");
  };
  ...
  return (
    <div className="measure-modal uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
      ...
      <h3 className="uk-modal-title">Revert Assessment Review</h3>
        ...
        >
          <div className="uk-width-1-1">
            <label className="uk-form-label" htmlFor="kpi-comments">
              Reasons / comments for reverting the Quater 4 review.
            </label>
...
export default CompanyScorecardQ4RejectionModal;
