...
const FYPlan = (props: IProps) => {
  ...
  const fyPlanCssClass = locked ? "FY-plan FY-plan__locked uk-card uk-card-default uk-card-body uk-card-small"
  ...
  return (
    <Fragment>
      ...
      <div className="themes-grid uk-grid-collapse uk-child-width-1-2@s uk-child-width-1-4@m uk-grid-match"
        data-uk-grid>
        {themes.map((theme) => (
          <div key={theme.id}>
