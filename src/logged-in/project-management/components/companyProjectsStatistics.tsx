...
const CompanyProjectStatistics = observer(() => {
    ...
    const departmentName = selectedValue !== "all" ? store.department.getItemById(selectedValue)?.asJson.name : "Company"
    ...
    }, [api.projectManagement, api.department, store.department.all.length]);
                ...
                <div className="basic-statistics">
                    <div className="s-item">
                        <div className="content">
                            <span>{departmentName} Projects Budget</span><br />
                    ...
                    <div className="s-item">
                        <div className="content">
                            ...
                            <span>{departmentName} Projects Progress</span>
                        </div>
                    </div>
                    <div className="s-item">
                        ...
                        <div className="content">
                            <span>{departmentName} Completed Projects</span>
                        </div>
                    </div>
                </div>
                <div className="graphs">
                    <div className="left">
                        <h4 style={{ textAlign: "center", fontWeight: "600" }}>{departmentName} Projects Budget</h4>
