...
import DocDefinition, {bodyText, boldText, marginTopBottom,subSectionHeader,} from "./DocDefition";
import Objective, { IObjective } from "../../models/Objective";
import Measure, { IMeasure } from "../../models/Measure";
import { dataTypeSymbol, totalQ4IndividualObjectiveRating} from "../../../logged-in/shared/functions/Scorecard";
