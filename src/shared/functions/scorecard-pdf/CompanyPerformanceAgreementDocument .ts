...
const tableHeader: Row = [
  ...
  // 
  { text: "Midterm E Rating", style: "tableHeader" },
  { text: "Midterm S Rating", style: "tableHeader" },
  { text: "Midterm F Rating", style: "tableHeader" },
  { text: "Assessment E Rating", style: "tableHeader" },
  { text: "Assessment S Rating", style: "tableHeader" },
  { text: "Assessment F Rating", style: "tableHeader" },
];
...
export const ConvertToTableRowItem = (objectives: IObjective[], measures: IMeasureCompany[]): ICompanyAgreementTableRowItem[] => {
  const sortByPerspective = (a: ICompanyAgreementTableRowItem, b: ICompanyAgreementTableRowItem) => {
    const order = ["F", "C", "I", "L"];
  ...
  const tableRows: ICompanyAgreementTableRowItem[] = measures.map((m) => {
    ...
    const strategic = objectives.find((o) => { return o.id === m.objective });
    ...
    const row: ICompanyAgreementTableRowItem = {
      ...
      // 
      rating: m.rating,
      q2supervisorRating: m.q2supervisorRating,
      q2FinalRating: m.q2FinalRating,
      q4rating: m.q4rating,
      q4supervisorRating: m.q4supervisorRating,
      q4FinalRating: m.q4FinalRating,
    };
...
const FormatTableSpan = (_rows: ICompanyAgreementTableRowItem[]) => {
  ...
  const rows: Row[] = _rows.map((row, _, data) => {
    ...
    return [
      ...
      row.rating || 0,
      row.q2supervisorRating || 0,
      row.q2FinalRating || 0,
      row.q4rating || 0,
      row.q4supervisorRating || 0,
      row.q4FinalRating || 0,
