...
const useReview = (
  ...
  useEffect(() => {
    ...
    switch (cycle) {
      case "Scorecard":
        _review = store.individualScorecardReview.draft.getItemById(uid);
        break;
      case "Midterm Reviews":
        _review = store.individualScorecardReview.quarter2.getItemById(uid);
        break;
      case "Assessment":
        _review = store.individualScorecardReview.quarter4.getItemById(uid);
        break;
      default:
        _review = undefined;
        break;
